            ...
            `}>
                <div className="flex flex-col h-full">
                    ...
                    <div className="p-6 border-b border-gray-200">
                        ...
                        <p className="text-gray-500 text-sm mt-1">Citizen Portal</p>
                    </div>
                    ...
                    <div className="px-4 sm:px-6 lg:px-8 py-4">
                        <div className="flex items-center justify-between">
                            ...
                            <div className="flex-1 lg:flex-none flex items-center justify-between lg:justify-start lg:space-x-4">
                                ...
                                <Link to="/user-dashboard" className="relative p-2 text-gray-600 hover:text-gray-900 transition-colors">
                                    <span className="text-xl">🔔</span>
                                    {unreadCount > 0 && (
