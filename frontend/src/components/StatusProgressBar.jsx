...
const StatusProgressBar = ({ status }) => {
    ...
    return (
        <div className="mb-6">
            <h4 className="text-lg font-medium text-gray-900 mb-5">Status Tracking</h4>

            <div className="relative px-2 sm:px-4">
                {/* Track background */}
                <div className="absolute top-[18px] left-[calc(16.66%)] right-[calc(16.66%)] h-[3px] bg-gray-200 rounded-full" />
                ...
                <div className="relative flex items-start justify-between">
                    ...
                    ${isCompleted
                                            ...
                                            : isCurrent
                                                ...
                                                : 'bg-gray-100 border-gray-200 text-gray-400 scale-100'
                                        }
            ...
            <div className="mt-5 text-center">
                {isComplete ? (
                    <div className="inline-flex items-center gap-2 px-5 py-2 rounded-full bg-green-50 border border-green-200 shadow-lg shadow-green-500/10">
                        <svg className="w-4 h-4 text-green-600" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2.5}>
                            <path strokeLinecap="round" strokeLinejoin="round" d="M9 12l2 2 4-4m6 2a9 9 0 11-18 0 9 9 0 0118 0z" />
                        </svg>
                        <span className="text-sm font-semibold text-green-600">Work Completed Successfully</span>
                    </div>
                ) : (
                    <span className="inline-block px-4 py-1.5 rounded-full text-xs font-medium bg-gray-100 border border-gray-200 text-gray-600">
