const Footer = () => {
    ...
    return (
        <footer className="border-t border-white/10 bg-[#0B0F1A]/95 backdrop-blur-sm">
                ...
                <div className="border-t border-white/10 pt-8">
                    <div className="flex flex-col md:flex-row justify-between items-center gap-4">
                        ...
                        <div className="flex gap-6 text-sm">
                            <a href="#privacy" className="text-white/60 hover:text-[#60A5FA] transition-colors">
                                Privacy
                            </a>
                            <a href="#terms" className="text-white/60 hover:text-[#60A5FA] transition-colors">
                                Terms
                            </a>
                            <a href="#cookies" className="text-white/60 hover:text-[#60A5FA] transition-colors">
                                Cookies
                            </a>
                        </div>
                    </div>
