    ...
    return (
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
            ...
            <div className="relative glass rounded-2xl p-6 md:p-8 w-full max-w-md transform transition-all duration-300">
                ...
                <div className="mb-4">
                    <p className="text-gray-600 text-sm mb-2">Complaint ID:</p>
                    <p className="text-gray-900 font-mono font-semibold">{complaintId}</p>
                </div>
                ...
                <form onSubmit={handleSubmit} className="space-y-5">
                    ...
                    <div>
                        ...
                        <select
                            ...
                            className="w-full px-4 py-3 bg-gray-50 border border-gray-300 rounded-lg text-gray-900 focus:outline-none focus:ring-2 focus:ring-[#3B82F6] focus:border-transparent transition-all duration-300 disabled:opacity-50 disabled:cursor-not-allowed"
                        >
