            ...
            <div className="max-w-7xl mx-auto">
                    ...
                    {filteredNotices.map((notice) => (
                        ...
                        >
                            <div className="flex items-start justify-between mb-3">
                                <span className="px-3 py-1 rounded-full text-xs font-medium bg-[#3B82F6]/10 text-[#3B82F6] border border-[#3B82F6]/30">
                                    {notice.department}
                                </span>
                ...
                {filteredNotices.length === 0 && (
                    <div className="text-center py-12">
                        <p className="text-gray-500 text-lg">No notices found for this department.</p>
                    </div>
                )}
                        ...
                        <div className="glass rounded-2xl max-w-4xl w-full max-h-[90vh] overflow-y-auto">
                            <div className="p-6 md:p-8">
                                ...
                                <div className="flex items-start justify-between mb-6">
                                    <div>
                                        ...
                                        <div className="flex items-center gap-3">
                                            ...
                                            <span className="text-xs text-gray-500">{selectedNotice.date}</span>
                                        </div>
                                    </div>
                                    <div className="flex items-center gap-3">
                                        <span className={`px-3 py-1 rounded-full text-xs font-medium ${
                                            selectedNotice.priority === 'high' ? 'text-red-700 bg-red-100 border-red-200' :
                                            selectedNotice.priority === 'medium' ? 'text-yellow-700 bg-yellow-100 border-yellow-200' :
                                ...
                                <div className="space-y-6">
                                    <div>
                                        <h4 className="text-gray-700 text-lg font-medium mb-3">Full Details</h4>
                                    ...
                                    <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                                        <div>
                                            <h4 className="text-gray-700 text-sm font-medium mb-3">Contact Information</h4>
                                            <div className="glass rounded-lg p-4 space-y-3">
                                                {selectedNotice.contactPerson && (
                                                    <div className="flex items-center gap-3">
                                                        ...
                                                        <div>
                                                            <p className="text-gray-900 font-medium text-sm">{selectedNotice.contactPerson}</p>
                                                ...
                                                {selectedNotice.contactPhone && (
                                                    <div className="flex items-center gap-2">
                                                        ...
                                                        <span className="text-gray-600 text-sm">{selectedNotice.contactPhone}</span>
                                                    </div>
                                                )}
                                            </div>
                                        </div>
                                        ...
                                        <div>
                                            <h4 className="text-gray-700 text-sm font-medium mb-3">Impact Information</h4>
                                            <div className="glass rounded-lg p-4 space-y-3">
                                                {selectedNotice.estimatedDuration && (
                                                    <div className="flex justify-between">
                                                        <span className="text-gray-500 text-sm">Duration:</span>
                                                        <span className="text-gray-900 text-sm">{selectedNotice.estimatedDuration}</span>
                                                    </div>
                                                )}
                                                {selectedNotice.affectedAreas && selectedNotice.affectedAreas.length > 0 && (
                                                    <div>
                                                        <span className="text-gray-500 text-sm block mb-2">Affected Areas:</span>
                                                        <div className="flex flex-wrap gap-2">
                                                            {selectedNotice.affectedAreas.map((area, index) => (
                                                                <span key={index} className="px-2 py-1 bg-gray-100 rounded text-gray-700 text-xs">
                                                                    {area}
                                                                </span>
                                                            ))}
                                                        </div>
